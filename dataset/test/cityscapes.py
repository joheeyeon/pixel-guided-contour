...
class Dataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        orig_img, inp, trans_input, trans_output, flipped, center, scale, inp_out_hw, rot_angle = \
            augment(
                img, self.split,
                ...
                flip_type=self.cfg.data.flip_type, gt_mask_labels=self.cfg.data.gt_mask_label
            )
