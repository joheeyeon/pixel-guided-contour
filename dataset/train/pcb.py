...
class PcbDataset(CocoDataset):
    pass

class PcbRasterDataset(CocoRasterDataset):
    pass
...
if __name__ == "__main__":
    ...
    cfg = importlib.import_module('configs.pcb.e2ec+pix.pcb_remove_same_e2ec+inpix+jointpix_416_v6')
