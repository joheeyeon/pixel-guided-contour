...
class Dataset(data.Dataset):
    ...
    def prepare_evolution(self, poly, img_gt_polys, can_gt_polys, keyPointsMask, img_gt_init_polys, can_gt_init_polys, img_gt_coarse_polys, can_gt_coarse_polys):
        ...
        img_gt_init_poly = uniformsample(poly, len(poly) * self.cfg.model.heads['wh'] / 2)
        ...
        img_gt_init_poly = get_img_gt(img_gt_init_poly, init_idx, t=self.cfg.model.heads['wh'] / 2)
    ...
    def get_gt_img(self, img_path, w, h):
    ...
    def __getitem__(self, base_index):
        ...
        gt_img = self.get_gt_img(image_path, w=width, h=height)
        ...
        data_input.update({'num_points_init': int(self.cfg.model.heads['wh'] / 2),
                           'num_points_coarse': self.cfg.commen.init_points_per_poly,
